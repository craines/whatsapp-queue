...
async function initChild(child, processFile) {
    ...
    await utils_1.parentSend(child, { cmd: interfaces_1.ChildCommand.Init, value: processFile });
    await onComplete;
}
class ChildPool {
    ...
    async retain(processFile) {
        ...
        child = child_process_1.fork(this.masterFile, [], { execArgv, stdio: 'pipe' });
    ...
    getAllFree() {
        return lodash_1.flatten(Object.values(this.free));
    }
}
