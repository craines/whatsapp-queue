...
class Worker extends queue_base_1.QueueBase {
    constructor(name, processor, opts = {}, Connection) {
        super(name, Object.assign(Object.assign({}, opts), { sharedConnection: utils_1.isRedisInstance(opts.connection) }), Connection);
        this.waiting = false;
        this.running = false;
        this.blockTimeout = 0;
    ...
    async waitForJob() {
        ...
        try {
            ...
            if (utils_1.isNotConnectionError(error)) {
     ...
     */
    async delay() {
        await utils_1.delay(utils_1.DELAY_TIME_1);
    }
    async nextJobFromJobData(jobData, jobId) {
        ...
        if (typeof jobData === 'number') {
            ...
            if ((_b = (_a = this.opts) === null || _a === void 0 ? void 0 : _a.limiter) === null || _b === void 0 ? void 0 : _b.workerDelay) {
                ...
                await utils_1.delay(rateKeyExpirationTime);
            }
            else {
