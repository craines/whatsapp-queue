...
class QueueEvents extends queue_base_1.QueueBase {
    constructor(name, _a = {}, Connection) {
        ...
        super(name, Object.assign(Object.assign({}, opts), { connection: utils_1.isRedisInstance(connection)
    ...
    async consumeEvents(client) {
        ...
        while (!this.closing) {
            try {
                ...
                if (utils_1.isNotConnectionError(err)) {
                    throw err;
                }
                await utils_1.delay(utils_2.DELAY_TIME_5);
            }
        }
    }
    close() {
